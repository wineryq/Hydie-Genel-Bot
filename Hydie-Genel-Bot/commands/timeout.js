...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const yetkiliRol = "YetkiliRolID";  // Buraya yetkili rol ID'sini yazın.

        const uyeYetki = new EmbedBuilder()
            .setColor("Red")
            .setDescription(`❌ | Bu komutu kullanabilmek için <@&${yetkiliRol}> rolüne sahip olmalısın!`);
        ...
        if (!interaction.member.roles.cache.has(yetkiliRol)) return interaction.reply({ embeds: [uyeYetki], ephemeral: true });
